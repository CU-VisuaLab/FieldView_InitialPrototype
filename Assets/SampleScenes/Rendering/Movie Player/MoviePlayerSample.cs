...
public class MoviePlayerSample : MonoBehaviour
{
	...
	{
		yield return null; // Delay until Unity has called MediaSurfaceInit from the render thread.
		yield return null;
		yield return null; // Main thread may run up to 2 frames ahead of render thread.

...
#region StartUpFunctions 
    ...
    /// <summary>
    /// Matt's workaround--set the pointer's parent to the visualization's canvas
    /// </summary>
    void SetPointerCanvas(GameObject c)
    {
        pointer.pointerObject.transform.SetParent(c.transform);
        pointer.pointerObject.transform.localRotation = Quaternion.identity;
